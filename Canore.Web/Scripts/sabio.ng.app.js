...
// CATEGORIES
sabio.ng.app.module.directive('gynCategories', [
function () {
	return {
		restrict: 'E',
		template: '',
...
sabio.ng.app.module.directive('obCategories', [
function () {
	return {
		restrict: 'E',
		template: '',
...
sabio.ng.app.module.directive('officeCategories', [
function () {
	return {
		restrict: 'E',
		template: '',
...
sabio.ng.app.module.filter('encodeUri', function ($window) {
...
sabio.ng.app.module.filter('htmlToPlaintext', function ($window) {
...
sabio.ng.app.module.factory('$eventsEnum', [
    function () {
    	return Object.freeze({
